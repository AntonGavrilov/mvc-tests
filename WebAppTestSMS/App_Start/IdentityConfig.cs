...
namespace WebAppTestSMS
{
    ...
    public class SmsService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            string accountSid = "ACf655b03ca01ae53d65f061428643848e";
            string accountToken = "0bac97b83e7c41d41ed947da31a92893";
            string twilioNumber = "+13852132420";

            TwilioClient.Init(accountSid, accountToken);

            // var twilio = new TwilioClient(;
